...
Бот использует простой интерфейс с кнопками. Для начала работы отправьте команду `/start`.

После запуска бота вам будет доступно главное меню с кнопками:

- **📝 Регистрация** - для регистрации нового пользователя
- **📊 Моя статистика** - показать статистику жизни (прожитые дни, недели, оставшееся время)
- **📅 Календарь жизни** - показать визуальный календарь жизни с отмеченными прожитыми неделями
- **✏️ Изменить данные** - редактировать профиль:
  - Изменить имя
  - Изменить дату рождения
  - Изменить ожидаемую продолжительность жизни
  - Настроить уведомления
  - Удалить профиль
- **ℹ️ О боте** - показать справку о возможностях бота

Все функции доступны через интуитивно понятные кнопки меню. Навигация осуществляется нажатием на соответствующие кнопки.
